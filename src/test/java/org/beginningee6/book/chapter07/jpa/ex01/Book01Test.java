...
public class Book01Test {
	...
	/**
	 * 複数（2つ）のBook01エンティティが永続化されている状態で、
	 * Book01クラスに定義した名前付きクエリを
	...
	public void testFindTwoBooks() throws Exception {
        ...
        List<Book01> books = em.createNamedQuery("Book01.findAllBooks", Book01.class).getResultList();
